...
module control (   
	...
	output logic [1:0]  pcmux, // PCMux
	output logic        drmux, //bit321mux
	output logic 		sr1mux, //bit321mux
	output logic		sr2mux, //mux21
	output logic		addr1mux, //mux21
	output logic [1:0]  addr2mux, //
	output logic [1:0]	aluk,
	output logic        mio_en, // done
	...
	begin
		...
		unique case (state)
			...
			s_33_3 : 
				state_nxt = s_35;
			s_35 : 
				state_nxt = s_32;   // change this later for week 2, pause_ir1
			// pause_ir1 and pause_ir2 are only for week 1 such that tas can see 
			// the values in ir.
			pause_ir1 : 
				if (continue_i) 
					state_nxt = pause_ir2; // set to pause for week 1
					// state_nxt = s_18; // set to pause for week 2
					// state_nxt = s_32;
			pause_ir2 : 
				if (~continue_i)	
					state_nxt = s_18;
			...
			s_21 :
				state_nxt = s_18;
			s_06 : //ldr
				state_nxt = s_25_1; // extra states to load memory
			s_25_1 :
				state_nxt = s_25_2;
			s_25_2 :
				state_nxt = s_25_3;
